...
- (void)userNotificationCenter:(UNUserNotificationCenter *)center
    ...
    NSLog(@"the cooler notification response: %@", response.notification.request.content.userInfo);
    // NSString* userId = response.notification.request.content.userInfo["userId"];
    completionHandler();
}
