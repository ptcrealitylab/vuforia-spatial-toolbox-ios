...
8) Download Vuforia SDK version 8.6.* from https://developer.vuforia.com/downloads/sdk (Click the
 "Download for iOS" link for *vuforia-sdk-ios-8-6-\*.zip*)
...
- paste VuforiaKey.h into the `vuforia-spatial-toolbox-ios/Vuforia Spatial Toolbox` directory
